const quotes = [
    ...
    "If today you are a little bit better than you were yesterday, then that’s enough. —David A",
...
window.onload = function() {
    ...
    setTimeout(function() {
        displayQuote();
        setInterval(displayQuote, 24 * 60 * 60 * 1000); // Change quote every 24 hours
    }, timeUntilMidnight);
};